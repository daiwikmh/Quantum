...
const sidebarItems = [
  ...
  { icon: MessageSquareMore, label: "TwitterAgent", href: "/agent" },
...
export function AppSidebar() {
  ...
  return (
    <Sidebar
      collapsible="icon"
      className="border-r border-gray-200 fixed h-screen bg-white shadow-sm z-50"
    >
            ...
            <SidebarMenuButton asChild size="lg">
              <Link to="/" className="flex items-center gap-2">
                <div
                  ...
                  } items-center justify-center rounded-full bg-black group-hover:bg-gray-900 transition-all`}
                >
                  <Wallet
                    className={`${
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-72 p-4 border-2 border-black rounded-3xl">
                <div className="mb-4 pb-3 border-b border-gray-200">
                  <h3 className="font-bold text-black font-montserrat mb-1">
                    USER
                  </h3>
                ...
                <div className="mb-4 pb-3 border-b border-gray-200">
                  <h3 className="font-bold text-black font-montserrat mb-2">
                    CONNECTED WALLETS
                  </h3>
                  {wallets.length > 0 ? (
                    <div className="space-y-2">
                      {wallets.map((wallet, index) => (
                        <div
                          key={index}
                          className="flex items-center space-x-2 p-2 bg-gray-50 rounded-xl"
                        >
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full rounded-full border-2 border-black bg-black text-white hover:bg-white hover:text-black font-montserrat"
                    >
